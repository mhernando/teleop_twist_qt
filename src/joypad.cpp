...
void JoyPad::paintEvent(QPaintEvent *event)
{
    ...
    painter.setPen(QPen(QBrush(Qt::green), m_bounds.width()* 0.010));
    ...
    gradient.setColorAt(0, QColor(20,40,20));//gray
    gradient.setColorAt(1, this->isEnabled()?Qt::black:Qt::gray); //darkGray
